      ...
      <div className="w-full min-h-screen [html.light_&]:bg-surface-card-light bg-[#0a0b0d] text-white flex flex-col font-sans px-6 md:px-10 relative pb-6">
        <div className="max-w-7xl mx-auto pt-4 w-full">
           ...
           <div className="mb-4">
              ...
              <p className="text-white/40 font-medium">Enter a meeting code and verify your devices to participate.</p>
           </div>
        </div>

        <div className="flex-1 flex items-center justify-center -mt-16 sm:-mt-10">
          <JoiningScreen
