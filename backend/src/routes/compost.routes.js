...
router.route('/replies/:replyId/replies').get(verifyJWT, getRepliesByReplyId);
router.route('/replies/:id/upvote').post(verifyJWT, upvoteReply); 
router.route('/replies/:id/downvote').post(verifyJWT, downvoteReply); 
router.route('/replies/:id/remove-upvote').post(verifyJWT, removeUpvoteReply); 
router.route('/replies/:id/remove-downvote').post(verifyJWT, removeDownvoteReply); 
