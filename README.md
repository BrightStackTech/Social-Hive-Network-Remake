...
A platform designed to foster community and collaboration among students from various universities. With collaborative features such as groups, communiities, channels, live sessions, _SocialHive_ is a small scale student hub.
...
- **Channels**: Follow subject or interest-based channels to stay updated with notes, resources, and announcements shared by channel admins.
...
- [Sumukh Kanekar](https://github.com/CrozzaX) 
